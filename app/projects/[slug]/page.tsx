...
const projects: Record<string, Project> = {
  ...
  "tameike-ai": {
    ...
    background: "当初は大学全体の研究データを一括収集する計画でしたが、学部ごとのデータ管理状況の差や権利関係の調整など、組織的な課題に直面しました。\n\nプロジェクトを停滞させないため、まず確実に取得できるデータで実証実験（PoC）を行う方針に転換。大学公式システムから取得した全授業シラバス（847授業分）をデータソースとするRAGチャットボットの開発から着手し、技術基盤を固めながら段階的にスケールアップする戦略へ舵を切りました。",
