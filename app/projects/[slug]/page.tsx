...
const projects: Record<string, Project> = {
  "ar-museum": {
    ...
    period: "2023 — 2024",
    badge: "夢チャレンジ採択",
    tags: ["Swift", "Object Capture API", "Unity", "LiDAR", "iOS", "AR"],
    ...
    challenge: "【はじめの一歩部門】Unityによるプロトタイプ開発\n開発環境を検討した結果、AR機能の扱いやすさとドキュメントの充実度からUnityを採用。当初はUnity上でLiDARスキャナのデータを直接読み込んで3Dモデルを生成しようとしましたが、精度低下や色再現の難しさが課題に。そこでApple純正のObject Capture技術を搭載したアプリ「KIRI Engine」を計測ツールに採用し、精度を大幅に改善しました。博物館内の暗い照明環境や障害物の映り込みといった実測時の課題にも、照明機材の追加導入や伸縮三脚の購入で対応。AR表示の実装方式もマーカー式と平面認識式を比較検討し、手間の少ない平面認識式を採用しました。\n\n【さらなる飛躍部門】Object Capture API・Swiftへの全面リニューアル\nAR品質のさらなる向上のため、サードパーティ製ゲームエンジンは使わずApple純正のObject Capture APIとSwiftのみで再実装。iOSデバイスに最適化したシームレスなAR体験を実現しています。また、スキャン精度を高めるため、事前に札幌・鹿児島の埋蔵文化財センターへ赴き現地調査を実施。そこで得たノウハウをもとに、2024年12月には博物館で2日間にわたるLiDARスキャンと3D計測を行いました。",
    result: "2024年12月に実施したLiDARスキャン・3D計測をもとに試作アプリを開発。2025年1月13日には八ヶ岳総合博物館で開催された正月イベントで、土器やはく製など収蔵品の3Dデータを取り込んだ試作アプリを公開し、来館者に実際に体験してもらいました。ガラス越しでしか見られなかった展示物を、誰もが持つスマートフォンで3D・AR鑑賞できる新しい展示体験として形にすることができました。\n\nこの取り組みは信濃毎日新聞でも「大学生・上村さん『土器ARプロジェクト』」として紹介されました。（https://www.nagano-np.co.jp/news/detail.php?id=2973）",
    program: {
      name: "夢チャレンジ制度",
      desc: "長野大学後援会が運営する学生支援制度。「大学時代にこんなことがしてみたい」という学生の企画を学内審査にかけ、採択された企画にのみ最高20万円の奨励金が支給される競争的資金です。毎年6件前後という狭き門を通過した、好奇心とチャレンジ精神を持つ学生の夢を資金面からバックアップしています。制度は新規の挑戦を後押しする「はじめの一歩！部門」と、実績をさらに発展させる「さらなる飛躍！！部門」の2部門で構成されており、本プロジェクトは「はじめの一歩！部門」で初採択された後、翌年「さらなる飛躍！！部門」で2年連続の採択を受けています。",
